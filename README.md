...
Este proyecto se generará con [Angular CLI](https://github.com/angular/angular-cli) versión 17.0.8.
...
Para obtener más ayuda sobre Angular CLI, usa `ng help` o consulta la [página de referencia y descripción general de Angular CLI](https://angular.io/cli).
